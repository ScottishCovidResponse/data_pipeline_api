...
public class ComponentsSerializer extends JsonSerializer<Components> {
  private static final Map<Class<?>, String> typeMapping = Map.of(
  ...
  @Override
  public void serialize(Components components, JsonGenerator gen, SerializerProvider serializers) throws IOException {
